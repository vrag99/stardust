//calling the function stake to get the staking rewards and depositing the amount in this contract 
// calling withdraw vairable to get the amounta nd stake rewards back to the user
