...
const headingVariants = cva(
  "tracking-tight pb-3 bg-clip-text font-display text-transparent",
  {
    variants: {
      variant: {
        default:
        ...
        color: "bg-gradient-to-tr from-primary-foreground from-10% to-primary to-[200%] animate-gradient",
      },
      size: {
